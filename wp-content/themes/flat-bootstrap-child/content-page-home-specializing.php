    ...
    <div class="section"><!-- specializing and logos -->
      <div class="container">
        ...
        <div id="home-logos" class="row">
          ...
          <div class="col-md-2 col-sm-3 col-xs-6" id="avvo2">
          ...
          <div class="col-md-2 col-sm-3 col-xs-6">
            <img class="alignnone size-full wp-image-904" src="http://localhost:8888/kousouros_law/wp-content/uploads/2013/03/image-alignment-150x150.jpg" alt="Image Alignment 150x150" width="150" height="150" />
          </div>
          <div class="col-md-2 col-sm-3 col-xs-6">
            <img class="alignnone size-full wp-image-904" src="http://localhost:8888/kousouros_law/wp-content/uploads/2013/03/image-alignment-150x150.jpg" alt="Image Alignment 150x150" width="150" height="150" />
          </div>        
